"""
CICIDS2017 — Dimensionality Reduction Script
=============================================
Run this AFTER cicids2017_cleaning.py.
...
Example (Windows):
    python cicids2017_dim_reduction.py --csv "C:/Users/rahul/programs/Python/NIDS(Unsupervised-learning)/Test/CICISC2017/cicids2017_cleaned.csv" --sample 30000 --pca_components 20
